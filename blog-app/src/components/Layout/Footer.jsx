...
export default function Footer(){
    return(
    <div className="mt-auto flex h-1 justify-center items-center">    
        <footer class="bg-white mt-auto flex" aria-labelledby="footer-heading">
            <h2 id="footer-heading" class="sr-only">Footer</h2>
            <div class="max-w-7xl mx-auto my-auto sm:px-6 lg:py-16 lg:px-8">
                <div class="xl:grid grid-cols-1 xl:gap-8">
                ...
                <div class=" mt-12 border-t border-gray-200 pt-8">
                    <p class="text-base text-gray-400 text-center">&copy; 2020 Workflow, Inc. All rights reserved.</p>
                </div>
            </div>
        </footer>
    </div>    
